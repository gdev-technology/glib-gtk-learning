\part{Further Reading\label{further-reading}}
...
The Autotools comprise three main components: Autoconf, Automake and Libtool. It is based on shell scripts, m4 macros and \shellcmd{make}.
