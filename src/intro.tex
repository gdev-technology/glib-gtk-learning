...
The guide is released as a Free/\emph{Libre} document and comes free of charge. But it does not materialize out of empty space; it takes time to write. By donating, you demonstrate your appreciation of this work and help its future development.
...
\section{Todo List for this Book and a Quick 2019 Update}
...
\begin{itemize}
  ...
  \item No longer recommend Jhbuild, recommend instead Flatpak\footnote{\url{https://flatpak.org/}} and BuildStream\footnote{\url{https://buildstream.build/}};
  \item Talk about the freedesktop.org\footnote{\url{https://www.freedesktop.org/}} specifications;
  \item The majority of active GNOME modules have been migrated to the Meson build system now (instead of the Autotools);
  \item Write a chapter about developing C/GObject libraries;
  \item Talk about the Rust programming language.
\end{itemize}
