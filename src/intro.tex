...
\emph{\gDocumentMainTitle} is a guide to get started with the GLib development platform, which permits to write C code more comfortably. There is a focus on best-practices for the code architecture and providing a high-level overview, giving references for further reading.
...
\url{https://github.com/gdev-technology/glib-gtk-learning} % TODO: adapt, drop the 'gtk' part.
...
But there is a lot of existing C/GLib code. Large projects cannot be rewritten overnight. So, some people still need to work with C and GLib.

\section{Todo List for this Book and a Quick 2024 Update}

\begin{itemize}
  \item Recommend Toolbx\footnote{\url{https://containertoolbx.org/}} and Flatpak\footnote{\url{https://flatpak.org/}}. JHBuild is less recommended. And there is also BuildStream\footnote{\url{https://buildstream.build/}};
