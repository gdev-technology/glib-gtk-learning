...
% Custom commands
\def\gDocumentMainTitle{The GLib/GTK Development Platform}
\def\gDocumentSecondaryTitle{A Getting Started Guide}
\def\gMainAuthorFirstName{Sébastien}
\def\gMainAuthorLastName{Wilmet}
\def\gBookVersion{0.9}
...
\usepackage{hyperref}
\hypersetup{
  pdfauthor = {\gMainAuthorFirstName{} \gMainAuthorLastName},
  pdftitle = {\gDocumentMainTitle},
  pdfcreator = {TeX},
  pdfproducer = {TeX},
  %colorlinks = false,
  pdfborder = 0 0 0
...
\title{\gDocumentMainTitle\\[0.3cm]
{\normalsize \gDocumentSecondaryTitle}\\[0.3cm]
{\normalsize Version \gBookVersion}}

\author{\gMainAuthorFirstName{} \textsc{\gMainAuthorLastName}}
