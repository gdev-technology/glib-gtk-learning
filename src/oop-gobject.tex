...
% Explain when it is necessary to disconnect signal handlers.
% Show complete code example with a semi-OOP class disconnecting its signal handler.
% Mention g_signal_connect_object().

%TODO write subsection
%\subsection{Properties}

% Show code example with the notify::detail signal.
% Property bindings.
